      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("<center><br><br><div class='container'><h2>SET YOUR LIGHT REACTIVITY LEVEL<h2/></div></center>");
            client.println("<center><div class='reactivity'>   <left><button type='submit' value='weak'    onmousedown=location.href='/W\'>Weak</button></center>");
            client.println("<center><div class='reactivity'>   <left><button type='submit' value='medium'    onmousedown=location.href='/M\'>Medium</button></center>");
            client.println("<center><div class='reactivity'>   <left><button type='submit' value='strong'    onmousedown=location.href='/S\'>Strong</button></center>");
        ...
        if (currentLine.endsWith("GET /W")) {
          tolerance = 100;
          Serial.println("Tolerance set to: ");
